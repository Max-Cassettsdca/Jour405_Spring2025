...
It contains a list of cities and the populations of certain races in each city. I'm not entirely sure what twoplusraces entails other than the obvious. I would think that baltimore city is the mowt diverse because it has the most people from different backgrounds.
...
Summerfeild has the highest race probabality and thats because its 94% black. Th most diverse population is Langley park but it also has a really small population.
...
I don't notice anything outstanding about the cities other than there is a mix between majority black and white populations. But I do notice that there is no lower percentage than around 50% of Hispanics being in that town.
...
Langley Park, Wheaton, and Adelphi are the cities where you are least likely to meet someone of your own race. The 3 most diverse cities are primarily located in Montgomery county and the area northeast of DC. THe least diverse are not to far mostly congregeating around the annapolis area.
...
Maryland at its most and least diverse.

Within less than 20 miles of each other are the most diverse cities in the state of Maryland according to a new poll from USA Today. Langley Park, Wheaton, and Adelphi are all located within Montgomery county, northeast of DC. But not far from the suburbs of the capitol are the antithesis. Cities surrounding the state capitol of Annapolis Such as Lake Shore and Lake Arbor rank lowest on that same census. not by any small margin either, you had less than a 20% chance of meeting someone of a different race in either Lake Shore or Lake Arbor. What are cultural and historical reasons such drastic statistics in cities not even half an hour away?

I'd talk to the mayors of all the cities involved as well as locals and local historians.
