...
```{r}
matches <- matches |> mutate (goal_diff = team_score - opponet_score)
```
...
There is close to no correlation at all because the spread is pretty even. It looks like a nothing shape and therefore means nothing and cant tell me anything except what the outliers in the data are. 
