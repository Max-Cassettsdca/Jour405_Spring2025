...
It is a useful model because it outlines the statistical significant of each factor so that you narrow down what exactly in your multiple variables is most statistically significant.
...
Points scored looks like the most obvious one in importance. and takeaways looks like it has the smallest effect on whether a team tins or not.
...
I would use the model by saying stuff like,

"Through an analysis of the data, the amount of yards gained and points scored obviously have the most impact on whether or not a game is won, but receiving a turnover was not as significant according to the data."  
