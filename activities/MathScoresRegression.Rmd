...
The relationship simply doesn't seem to be fair. Its way weighted to the left sde of the graph because the majority of farms percentages are that low. 
...
There is no statisitcally significanvce to the study with the numbers weve seen thus far.
...
It looks to me that the lower absolute residuals have lower farm percentages, which we already knew. Although I'm seeing that higher and lower math scores aren't affected by the residuals. I'm seeing some interesting anomalies when you compare the math scores and farms percentages. Although in realizing that anomaly that kids who need food at school and are considered lower middle class might not be smart enough to These scores struck a weird chord. I don't know the data well enough to say that lower-income schools have lower test scores, but if that is the case (which i dont know if i should just assume) then these kids with higher math scores in higher farms percentage Schools might be up to something. A lot of assumptions there.
...
I would say that my initial reaction is that there are some schools with higher farm percentages that are getting higher test scores, which is impressive. What these teachers are doing for their students is impressive, that is. So I would investigate what exactly these teachers were doing so that it could be studied and replicated in other low income schools with low math scores.
