...
I'd say that the grade data shows that there is a meaningful difference between the two frequencies. Enough of a difference to warrant some looking into at least. The reason for this is because in the whole data set there was a collectove difference of sixty people, if that makes sense. There were a lot of differences and even though they werent all big they were still significant collectively. 
...
We reject the null hypotheses as the critical value ( 9.487729) is less than than 11.667.
...
The discrepancies are a lot higher in the top range than they are at the lower, so I would ask questions regarding whether his questions on tests and quizzes are too difficult or if the class has study guides with "closer to actual" test questions so that the students can get a better grip on what will be expected of them in assessments.
