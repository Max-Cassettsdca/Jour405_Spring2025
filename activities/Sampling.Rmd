...
The mean and standard deviation are in tangent with each other, and by that I mean that it exemplifies a curve. If the sample size is to much or two little then there is more standard deviation but there is a number that is just right that exemplifies the datas mean best. 
