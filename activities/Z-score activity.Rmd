...
10 would be my guess for the number of calls that would be called the average.I don't see a pattern at first, but I do notice spikes down and spikes up in July and October.
...
It looks like there are a lot of unusually high scores in the summer.After looking at the graph below, I'd say that I can draw better conclusions as to what the patterens might be or at the very least when 911 calls fluxuate. 
...
I confused by the way the question is posed, but what I think youre asking is to talk about the pattern in the calls per day of the week. Im pretty sure you want me to do it from the journalism POV where I'm talking to you as a reporter would too, so lets give it a crack. 

Compared to other days thursdays are the least busy day for 911 call centers, while Saturdays are the most.
...
There are a few angles that we can take. For instance, why are overdoses increasing in the spring and falling in the fall?  I would start investigating the communities that these calls are coming from, and observing them, I suppose. Is it because more people are outside and socializing, and Fent and other party drugs are going to be more in the open? Are drugs more likely to be used in the summer than the winter.