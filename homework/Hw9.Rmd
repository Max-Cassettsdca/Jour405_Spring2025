...
It looks like the average has definetly improved. I can tell by just looking at the numbers, they're all above 72 and for the most part there's massive improvement from the average all around.
...
First of all the the mean is higher (meaning better test scores) and the standard deviation is lower which means that its a more accurate reading. I'd proably ask why test scores are going up.
...
The Improvement of Maryland Schools this year.
...
**Hypotheses:**
Null: The new reading program didn't have an impact on test scores
Alternative: The new reading program did have an impact on test scores
...
The P value tells us wether or not the info given to us is an accurate indicator of the situation or not and this P value shows us that there is definetly a difference being made by the reading program. I would say that when tested to see if there was an improvement in  reading scores in schools in the district, there was a definite improvement found after the new program was implemented.
...
The Maryland education system has been skating by on a C minus in reading scores. But a new reading program introduced last year could curve the grade. Our paper took a survey of 12 random schools average test scores from last year and this year after the reading program was introduced and the data unequivically points to an increase in terst scores in all 12 schools since the previuos year.


### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?

Number of turoting programs or new equipment bought by the school or how long the average teacher spent at that school.
