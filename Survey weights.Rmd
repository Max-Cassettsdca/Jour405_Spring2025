...
It looks like the weights range from under 1% to a little under 3%. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

I suppose if theres a weight of 0.23 there really isnt much of a weight, i assume that the weight (which I'm pretty sure is to help counter the screw of any over represented group in a survey), can also represent how close to the mean of all resposndent groups a certain group is. In this case 3.04 would be father from the mean and would need to be curbed.

3. Why might some respondents be weighted more heavily than others?

Because they are over represented in the survey.
...
It looks like the biggest weight is in rarley/never. I'm a little confused what the point of saying that a certin percent said No and Yes and Unsure for a certain way of voting, instead of just saying that they needed to pick if they rarly, sporadically, or always vote?

2. How might these differences affect reporting on likely voter turnout?

I sincerely dont think it affects voting all that much because people are still more likely to vote than not vote by a significant margin
...
I think that this might tell us that the group that said they wouldnt usually vote was over represented in the survey set
