...
it looks like monthly car thefts for the last few years are trending down overall.
...
First of all a standard deviation of 96 is crazy and could swing the whole graph any which way. My opinion of the graph in task three hasnt changed otherwise.
...
The confidence interval which is the shaded section tells us that we are 95% certain the true average is somewhere within that shaded region. I would say the most recent graph definelty gives a more accurate example to the data, I mean that standard deviation is nuts. I think the headline ought to be; Maryland car thefts down on average, but should we expect another spike before it gets better?
...
I mean there is a statistically signifact difference but the standard deviation is just to big and even if there is a trend it doesn't seem to be worth the risk saying that there is something there definitively. I'd expect her to ask me if i'm high because with wonky data thats sporadic like this with a huge standard deviation theres no way this ought to be published in my opinion.
